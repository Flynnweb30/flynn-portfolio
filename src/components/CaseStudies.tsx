      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {CASE_STUDIES.map((study) => (
            <div
              key={study.id}
              className="bg-[#0f172a] rounded-2xl border border-slate-800 hover:border-blue-500/50 p-6 sm:p-8 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-blue-950/20 group"
            ...
            >
              <div>
                ...
                <div className="pt-4 mb-4">
                  ...
                  <div className="mt-3 inline-flex items-baseline gap-2 bg-blue-950/60 border border-blue-500/40 px-3.5 py-1.5 rounded-xl">
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Primary Outcome:</span>
                    <span className="text-lg sm:text-xl font-extrabold text-blue-300 font-heading">
                ...
                {study.quote && (
                  <div className="p-3.5 bg-slate-900/90 border border-slate-800 rounded-xl my-4 text-xs text-slate-300 italic">
                    <Quote className="w-3.5 h-3.5 text-blue-400 inline mr-1 -mt-1" />
                    "{study.quote.text}"
                    <div className="text-[11px] text-blue-300 font-bold not-italic mt-1">
              ...
              <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold text-blue-300 hover:text-white bg-blue-950/40 hover:bg-blue-500/20 border border-blue-500/40 rounded-lg transition-all"
                >
