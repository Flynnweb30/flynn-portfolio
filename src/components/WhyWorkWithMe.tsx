  ...
  return (
    <section id="why-work-with-me" className="py-24 bg-[#0a0f1c] relative border-t border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {reasons.map((reason, idx) => {
            ...
            return (
              <div
                key={reason.title}
                className="bg-[#0f172a] rounded-2xl border border-slate-800 p-7 hover:border-blue-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-blue-950/20 flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-5">
                    <div className="w-12 h-12 rounded-xl bg-blue-950/70 border border-blue-500/30 flex items-center justify-center text-blue-400 group-hover:bg-blue-400 group-hover:text-slate-950 transition-all">
                  ...
                  <div className="text-xs text-blue-400/90 font-medium mt-0.5 mb-3">
                    {reason.subtitle}
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center gap-1.5 text-xs text-slate-400 group-hover:text-blue-400 transition-colors">
        ...
        <div className="bg-gradient-to-r from-blue-950/30 via-slate-900 to-blue-950/30 border border-blue-500/30 rounded-2xl p-8 max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-6">
          <div className="w-16 h-16 rounded-full bg-blue-400 text-slate-950 font-bold text-2xl flex items-center justify-center shrink-0">
            "
          </div>
          ...
          <button
            ...
            className="shrink-0 px-5 py-3 text-xs font-bold text-slate-950 bg-blue-400 hover:bg-blue-300 rounded-xl shadow-md shadow-blue-500/20 transition-all whitespace-nowrap"
          >
