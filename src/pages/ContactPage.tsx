...
export const ContactPage: React.FC<ContactPageProps> = ({ initialService }) => {
  useEffect(() => {
    document.title = 'Contact & Proposal Request | Flynn James';
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute(
        'content',
        'Initiate a direct outbound inquiry with Flynn James. Share your ICP, calling volume targets, and current sales challenges for a targeted outbound assessment.',
      );
    }
  }, []);
